...
To start GoAnimate 2014 Stable on Windows, open start_goanimate.bat. It'll automate just about everything for you and, well, start GoAnimate 2014 Stable. On your first run, you will likely need to right-click it and click "Run as Administrator". This allows it to properly install what it needs to run. After your initial run, you shouldn't need to do that again, you can start it as normal. **Currently there is no support for Linux or MacOS**.
